...
export const AVAILABLE_SERVICES: ServiceDef[] = [
  ...
  // ─── NEW SERVICES (50+) ──────────────────────────────────
  // Communication
  { id: "microsoft_teams", name: "Microsoft Teams", description: "Send messages, create channels, manage meetings", icon: "💼", authType: "oauth", docsUrl: "https://learn.microsoft.com/en-us/graph/api", category: "Communication", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "whatsapp_business", name: "WhatsApp Business", description: "Send templates, media, manage conversations", icon: "📱", authType: "apikey", docsUrl: "https://developers.facebook.com/docs/whatsapp", category: "Communication", configFields: [{ key: "phone_number_id", label: "Phone Number ID", type: "text", required: true }, { key: "access_token", label: "Access Token", type: "password", required: true }] },
  { id: "twilio", name: "Twilio", description: "SMS, voice calls, WhatsApp, video", icon: "📞", authType: "apikey", docsUrl: "https://www.twilio.com/docs", category: "Communication", configFields: [{ key: "account_sid", label: "Account SID", type: "text", required: true }, { key: "auth_token", label: "Auth Token", type: "password", required: true }] },
  { id: "sendgrid", name: "SendGrid", description: "Transactional email, marketing campaigns", icon: "📨", authType: "apikey", docsUrl: "https://docs.sendgrid.com/", category: "Communication", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "mailgun", name: "Mailgun", description: "Email API, validation, tracking", icon: "🔫", authType: "apikey", docsUrl: "https://documentation.mailgun.com/", category: "Communication", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }, { key: "domain", label: "Domain", type: "text", required: true }] },
  // Developer
  { id: "vercel", name: "Vercel", description: "Deploy, manage projects, serverless functions", icon: "▲", authType: "oauth", docsUrl: "https://vercel.com/docs/rest-api", category: "Developer", configFields: [{ key: "token", label: "Access Token", type: "password", required: true }] },
  { id: "netlify", name: "Netlify", description: "Deploy sites, manage DNS, serverless functions", icon: "🌐", authType: "apikey", docsUrl: "https://docs.netlify.com/api/", category: "Developer", configFields: [{ key: "token", label: "Personal Access Token", type: "password", required: true }] },
  { id: "railway", name: "Railway", description: "Deploy apps, databases, manage variables", icon: "🚂", authType: "apikey", docsUrl: "https://docs.railway.app/reference/api", category: "Developer", configFields: [{ key: "token", label: "API Token", type: "password", required: true }] },
  { id: "render", name: "Render", description: "Deploy web services, databases, static sites", icon: "🎨", authType: "apikey", docsUrl: "https://render.com/docs/api", category: "Developer", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "circleci", name: "CircleCI", description: "CI/CD pipelines, orbs, workflows", icon: "⭕", authType: "apikey", docsUrl: "https://circleci.com/docs/api/", category: "Developer", configFields: [{ key: "token", label: "Personal API Token", type: "password", required: true }] },
  { id: "firebase", name: "Firebase", description: "Firestore, Auth, Functions, Hosting, Messaging", icon: "🔥", authType: "apikey", docsUrl: "https://firebase.google.com/docs", category: "Developer", configFields: [{ key: "service_account", label: "Service Account JSON", type: "password", required: true }, { key: "project_id", label: "Project ID", type: "text", required: true }] },
  // Productivity
  { id: "clickup", name: "ClickUp", description: "Tasks, docs, goals, whiteboards, dashboards", icon: "☑️", authType: "oauth", docsUrl: "https://clickup.com/api/", category: "Productivity", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "monday", name: "Monday.com", description: "Work OS, boards, items, automations", icon: "📅", authType: "apikey", docsUrl: "https://developer.monday.com/api-reference", category: "Productivity", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  { id: "coda", name: "Coda", description: "Docs, tables, automations, packs", icon: "📋", authType: "apikey", docsUrl: "https://coda.io/developers", category: "Productivity", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "airtable", name: "Airtable", description: "Databases, views, automations, interfaces", icon: "🗄️", authType: "oauth", docsUrl: "https://airtable.com/developers/web/api/introduction", category: "Productivity", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "dropbox", name: "Dropbox", description: "File storage, sharing, team folders", icon: "📦", authType: "oauth", docsUrl: "https://www.dropbox.com/developers/documentation/http/documentation", category: "Productivity", configFields: [{ key: "app_key", label: "App Key", type: "text", required: true }, { key: "app_secret", label: "App Secret", type: "password", required: true }] },
  { id: "evernote", name: "Evernote", description: "Notes, notebooks, tags, search", icon: " elephant", authType: "oauth", docsUrl: "https://dev.evernote.com/doc/", category: "Productivity", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "todoist", name: "Todoist", description: "Tasks, projects, labels, filters", icon: "✅", authType: "apikey", docsUrl: "https://developer.todoist.com/rest/v2", category: "Productivity", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  // AI
  { id: "replicate", name: "Replicate", description: "Run ML models, image/video/audio generation", icon: "🔄", authType: "apikey", docsUrl: "https://replicate.com/docs", category: "AI", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  { id: "cohere", name: "Cohere", description: "NLP models, embeddings, classification", icon: "🔮", authType: "apikey", docsUrl: "https://docs.cohere.com/", category: "AI", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "groq", name: "Groq", description: "Ultra-fast LLM inference, GroqCloud", icon: "⚡", authType: "apikey", docsUrl: "https://console.groq.com/docs", category: "AI", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "together_ai", name: "Together AI", description: "Open-source models, fine-tuning, inference", icon: "🤝", authType: "apikey", docsUrl: "https://docs.together.ai/", category: "AI", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "huggingface", name: "Hugging Face", description: "Models, datasets, spaces, inference API", icon: "🤗", authType: "apikey", docsUrl: "https://huggingface.co/docs/api-inference", category: "AI", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  // Social
  { id: "linkedin", name: "LinkedIn", description: "Posts, profile, company pages, analytics", icon: "💼", authType: "oauth", docsUrl: "https://learn.microsoft.com/en-us/linkedin/", category: "Social", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "tiktok", name: "TikTok", description: "Video upload, user info, analytics", icon: "🎵", authType: "oauth", docsUrl: "https://developers.tiktok.com/doc/", category: "Social", configFields: [{ key: "client_key", label: "Client Key", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "instagram", name: "Instagram", description: "Media publishing, insights, stories", icon: "📸", authType: "oauth", docsUrl: "https://developers.facebook.com/docs/instagram-api", category: "Social", configFields: [{ key: "access_token", label: "Access Token", type: "password", required: true }] },
  { id: "mastodon", name: "Mastodon", description: "Posts, timelines, notifications, search", icon: "🐘", authType: "apikey", docsUrl: "https://docs.joinmastodon.org/api/", category: "Social", configFields: [{ key: "instance_url", label: "Instance URL", type: "url", required: true }, { key: "access_token", label: "Access Token", type: "password", required: true }] },
  { id: "pinterest", name: "Pinterest", description: "Pins, boards, analytics, shopping", icon: "📌", authType: "oauth", docsUrl: "https://developers.pinterest.com/docs/", category: "Social", configFields: [{ key: "app_id", label: "App ID", type: "text", required: true }, { key: "app_secret", label: "App Secret", type: "password", required: true }] },
  { id: "reddit_api", name: "Reddit (OAuth)", description: "Posts, comments, subreddits, search via OAuth", icon: "🔴", authType: "oauth", docsUrl: "https://www.reddit.com/dev/api/oauth", category: "Social", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  // Business
  { id: "quickbooks", name: "QuickBooks", description: "Accounting, invoicing, expenses, reports", icon: "💰", authType: "oauth", docsUrl: "https://developer.intuit.com/app/developer/qbo/docs/api", category: "Business", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "xero", name: "Xero", description: "Accounting, invoices, contacts, bank feeds", icon: "📊", authType: "oauth", docsUrl: "https://developer.xero.com/documentation/api/accounting/overview", category: "Business", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "paypal", name: "PayPal", description: "Payments, invoices, subscriptions, payouts", icon: "💳", authType: "oauth", docsUrl: "https://developer.paypal.com/docs/api/overview/", category: "Business", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "square", name: "Square", description: "Payments, catalog, inventory, customers", icon: "◼️", authType: "oauth", docsUrl: "https://developer.squareup.com/reference/square", category: "Business", configFields: [{ key: "application_id", label: "Application ID", type: "text", required: true }, { key: "access_token", label: "Access Token", type: "password", required: true }] },
  { id: "salesforce", name: "Salesforce", description: "CRM, leads, opportunities, reports", icon: "☁️", authType: "oauth", docsUrl: "https://developer.salesforce.com/docs", category: "Business", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  // DevOps
  { id: "gcp", name: "Google Cloud Platform", description: "Compute, storage, ML, BigQuery, Cloud Run", icon: "☁️", authType: "apikey", docsUrl: "https://cloud.google.com/docs", category: "DevOps", configFields: [{ key: "service_account", label: "Service Account JSON", type: "password", required: true }, { key: "project_id", label: "Project ID", type: "text", required: true }] },
  { id: "azure", name: "Microsoft Azure", description: "VMs, storage, AI, DevOps, Active Directory", icon: "☁️", authType: "apikey", docsUrl: "https://learn.microsoft.com/en-us/rest/api/azure/", category: "DevOps", configFields: [{ key: "subscription_id", label: "Subscription ID", type: "text", required: true }, { key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }, { key: "tenant_id", label: "Tenant ID", type: "text", required: true }] },
  { id: "cloudflare", name: "Cloudflare", description: "CDN, DNS, Workers, R2, D1, Pages", icon: "☁️", authType: "apikey", docsUrl: "https://developers.cloudflare.com/api/", category: "DevOps", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  { id: "digitalocean", name: "DigitalOcean", description: "Droplets, Kubernetes, databases, spaces", icon: "🌊", authType: "apikey", docsUrl: "https://docs.digitalocean.com/reference/api/", category: "DevOps", configFields: [{ key: "api_token", label: "Personal Access Token", type: "password", required: true }] },
  { id: "fly_io", name: "Fly.io", description: "Deploy apps globally, machines, volumes", icon: "🦋", authType: "apikey", docsUrl: "https://fly.io/docs/flyctl/tokens/", category: "DevOps", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  { id: "heroku", name: "Heroku", description: "Deploy apps, manage add-ons, pipelines", icon: "💜", authType: "apikey", docsUrl: "https://devcenter.heroku.com/articles/platform-api-reference", category: "DevOps", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }] },
  { id: "terraform", name: "Terraform Cloud", description: "Infrastructure as code, workspaces, state", icon: "🏗️", authType: "apikey", docsUrl: "https://developer.hashicorp.com/terraform/cloud-docs/api-docs", category: "DevOps", configFields: [{ key: "api_token", label: "API Token", type: "password", required: true }] },
  // Design
  { id: "canva", name: "Canva", description: "Design creation, templates, brand kits", icon: "🎨", authType: "oauth", docsUrl: "https://www.canva.dev/docs/connect/", category: "Design", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "dribbble", name: "Dribbble", description: "Design shots, portfolios, teams", icon: "🏀", authType: "oauth", docsUrl: "https://developer.dribbble.com/", category: "Design", configFields: [{ key: "client_id", label: "Client ID", type: "text", required: true }, { key: "client_secret", label: "Client Secret", type: "password", required: true }] },
  { id: "unsplash", name: "Unsplash", description: "Stock photos, search, collections", icon: "📷", authType: "oauth", docsUrl: "https://unsplash.com/documentation", category: "Design", configFields: [{ key: "access_key", label: "Access Key", type: "password", required: true }] },
  // Data
  { id: "snowflake", name: "Snowflake", description: "Cloud data warehouse, SQL analytics", icon: "❄️", authType: "apikey", docsUrl: "https://docs.snowflake.com/en/developer-guide/sql-api/index", category: "Data", configFields: [{ key: "account", label: "Account", type: "text", required: true }, { key: "username", label: "Username", type: "text", required: true }, { key: "password", label: "Password", type: "password", required: true }] },
  { id: "bigquery", name: "BigQuery", description: "Serverless data warehouse, ML, analytics", icon: "🔍", authType: "apikey", docsUrl: "https://cloud.google.com/bigquery/docs/reference/rest", category: "Data", configFields: [{ key: "service_account", label: "Service Account JSON", type: "password", required: true }, { key: "project_id", label: "Project ID", type: "text", required: true }] },
  { id: "mongodb_atlas", name: "MongoDB Atlas", description: "Cloud database, search, vector search", icon: "🍃", authType: "apikey", docsUrl: "https://www.mongodb.com/docs/atlas/api/", category: "Data", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }, { key: "project_id", label: "Project ID", type: "text", required: true }] },
  { id: "redis_cloud", name: "Redis Cloud", description: "In-memory database, caching, pub/sub", icon: "🔴", authType: "apikey", docsUrl: "https://redis.com/docs/ri-api/", category: "Data", configFields: [{ key: "api_key", label: "API Key", type: "password", required: true }, { key: "account_id", label: "Account ID", type: "text", required: true }] },
  { id: "supabase_db", name: "Supabase (Database)", description: "Postgres, auth, storage, edge functions", icon: "⚡", authType: "apikey", docsUrl: "https://supabase.com/docs/reference/api", category: "Data", configFields: [{ key: "url", label: "Project URL", type: "url", required: true }, { key: "service_key", label: "Service Role Key", type: "password", required: true }] },
];
