...
export function RagPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto w-full" onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
      {dragOver && (<div className="fixed inset-0 z-50 bg-[#F59E0B]/5 backdrop-blur-sm flex items-center justify-center pointer-events-none"><div className="bg-[#12121a] border-2 border-dashed border-[#F59E0B]/50 rounded-lg px-8 py-6 text-center shadow-2xl"><FolderOpen size={32} className="mx-auto mb-2 text-[#F59E0B]" /><p className="text-[#FCD34D] text-lg font-bold mb-1">Drop files or folder here</p><p className="text-[#71717A] text-xs">TXT, MD, PDF, CSV, JSON, XML, HTML</p></div></div>)}

      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md bg-gradient-to-br from-[#F59E0B] to-[#F59E0B] flex items-center justify-center shadow-[0_0_20px_rgba(245,158,11,0.3)]"><BookOpen size={20} className="text-white" /></div>
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-4"><div className="glass-panel rounded-md p-4 border border-[rgba(255,255,255,0.06)]">
          ...
          : (() => {
            ...
            return (<div className="space-y-1.5 max-h-[500px] overflow-y-auto">
              {displayed.map((doc) => (<div key={doc.id} onClick={() => viewDoc(doc)} className={`flex items-center gap-2 p-2 rounded-lg cursor-pointer border transition-all ${selectedDoc?.id === doc.id ? "bg-[rgba(245,158,11,0.1)] border-[rgba(245,158,11,0.3)]" : "bg-[rgba(255,255,255,0.02)] border-[rgba(255,255,255,0.06)] hover:border-[rgba(255,255,255,0.12)]"}`}>
        ...
        <div className="col-span-8 space-y-4">
          <div className="glass-panel rounded-md p-4 border border-[rgba(255,255,255,0.06)]"><h3 className="text-[10px] text-[#A1A1AA] uppercase tracking-wider font-medium mb-3">Ask your documents</h3>
