      ...
      {tab === "rules" && (
        <div className="glass-panel rounded-xl p-5 mb-6">
          ...
          <div className="flex justify-end mt-3">
            <button
              className="btn-nova px-4 py-1.5 rounded text-xs flex items-center gap-1.5 disabled:opacity-40 disabled:cursor-not-allowed"
              onClick={saveRules}
              disabled={saving}
            >
        ...
        <div className="glass-panel rounded-xl p-5 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end pt-2 border-t border-[rgba(255,255,255,0.06)]">
              <button className="btn-nova px-4 py-1.5 rounded text-xs flex items-center gap-1.5"
                onClick={async () => {
                  try {
        ...
        <div className="glass-panel rounded-xl p-5 mb-6">
          ...
          {loadingAppearance ? (
            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-end pt-2 border-t border-[rgba(255,255,255,0.06)]">
                <button className="btn-nova px-4 py-1.5 rounded text-xs flex items-center gap-1.5" onClick={saveAppearance}>
                  <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>
                  Save Appearance
                </button>
              </div>
