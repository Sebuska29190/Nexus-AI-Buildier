    ...
    <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="space-y-4">
            <div>
              ...
              <label className={`flex flex-col items-center justify-center gap-2 p-6 border-2 border-dashed rounded-lg cursor-pointer transition-all ${videoFileName ? "border-[#F59E0B]/50 bg-[#F59E0B]/5" : "border-slate-700 bg-[#020408]/40 hover:border-slate-500"}`}>
                {videoFileName ? (
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <button onClick={loadJobs} className="text-[10px] text-[#F59E0B] hover:underline">Refresh</button>
        </div>
        {jobs.length === 0 ? (
