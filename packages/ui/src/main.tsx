...
try {
  ...
  btn.style.cssText = "padding:0.5rem 1rem;border-radius:0.75rem;border:1px solid rgba(245,158,11,0.2);background:rgba(245,158,11,0.06);color:#e8ecf2;cursor:pointer;font-family:inherit";
